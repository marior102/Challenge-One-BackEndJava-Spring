...
public class Dolar  implements Monedas {
	...
	private String url = "#exchange-usd";
	private Icon icon;
	private boolean validar;
	private Map<String, String> tablaDivisa;
	
	public Dolar() {
		this.setNombreDivisa("Dolar");
	...
	public Dolar(String nombreDivisa, String simboloDivisa, String compra, String venta) {
	...
	public Dolar(String nombreDivisa, String simboloDivisa) {
