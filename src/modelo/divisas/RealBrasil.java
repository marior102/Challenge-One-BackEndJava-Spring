...
public class RealBrasil  implements Monedas {
	...
	private String url = "#exchange-brl";
	private Icon icon;
	private boolean validar;
	private Map<String, String> tablaDivisa;
	
	public RealBrasil() {
		this.setNombreDivisa("Real Brasil");
		this.setSimboloDivisa("R$");
		...
		this.setIcon((ImageIcon) Utilidades.setImage(new ImageIcon(getClass().getResource("/Imagenes/BRL.png")), 25));
	}
	public RealBrasil(String nombreDivisa, String simboloDivisa) {
	...
	public RealBrasil(String nombreDivisa, String simboloDivisa, String compra, String venta) {
