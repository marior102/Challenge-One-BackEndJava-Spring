...
public class Libra  implements Monedas {
	...
	private String url = "#exchange-gbp";
	private Icon icon;
	private boolean validar;
	private Map<String, String> tablaDivisa;
	
	public Libra() {
		this.setNombreDivisa("Libra");
		...
		this.setIcon((ImageIcon) Utilidades.setImage(new ImageIcon(getClass().getResource("/Imagenes/GBP.png")), 25));
		
	}
	public Libra(String nombreDivisa, String simboloDivisa) {
	...
	public Libra(String nombreDivisa, String simboloDivisa, String compra, String venta) {
