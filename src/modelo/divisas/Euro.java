...
public class Euro  implements Monedas {
	...
	private String url = "#exchange-eur";
	private Icon icon;
	...
	public Euro() {
		...
		this.setIcon((ImageIcon) Utilidades.setImage(new ImageIcon(getClass().getResource("/Imagenes/EUR.png")), 25));
		
	}
	public Euro(String nombreDivisa, String simboloDivisa) {
...
public Euro(String nombreDivisa, String simboloDivisa, String compra, String venta) {
